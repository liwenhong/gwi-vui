  ...
  <div>
    ...
    >
      <div class="gwi-model">
        <div
          v-if="showTitle"
          class="gwi-model__title gwi-line-1"
          :style="[titleStyle]"
        >
          {{ title }}
        </div>
        <div class="gwi-model__content">
          <div :style="[contentStyle]" v-if="$slots.default || $slots.$default">
            <slot />
          </div>
          <div
            v-else
            class="gwi-model__content__message"
            :style="[contentStyle]"
          >
            {{ content }}
          </div>
        ...
        <div
          class="gwi-model__footer gwi-border-top"
          v-if="showCancelButton || showConfirmButton"
        >
          <div
            v-if="showCancelButton"
            :hover-stay-time="100"
            hover-class="gwi-model__btn--hover"
            class="gwi-model__footer__button"
          ...
          <div
            ...
            :hover-stay-time="100"
            :hover-class="'gwi-model__btn--hover'"
            class="gwi-model__footer__button hairline-left"
 ...
 */
import GwiPopup from "../../Popup";
import GwiLoading from "../../Loading";
export default {
  name: "gwi-modal",
  components: { GwiPopup, GwiLoading },
  props: {
    // 是否显示Modal
    value: {
      type: Boolean,
